...
📁 **frontend-templates/** - Ready-to-use theme files
...
# 3. Copy theme file
mkdir -p src
cp ../erp-product-be/frontend-templates/theme.js src/

# 4. Copy design system CSS (optional if using MUI)
cp ../erp-product-be/frontend-templates/design-system.css src/
...
1. **Copy theme files to your React project**
   ```bash
   cp frontend-templates/theme.js src/
   # OR
   cp frontend-templates/design-system.css src/
   ```
